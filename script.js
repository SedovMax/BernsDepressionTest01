...
// ====Логика вычесления ==============================================
 ...
 //====Логика результата=========================================
    if(result <= 5){
      $('.result').html("<span>76–100 Крайняя степень депрессии. Вы набрали: " + result + " из 100.</span><button href='https://vk.me/public212988636' class='diagnostics' target='_blank'>Записаться на консультацию к психологу</button><button class='sub'>Подписаться на сообщество</button>");
    }
